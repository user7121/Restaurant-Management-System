...
![CI Pipeline](https://github.com/user7121/Restaurant-Management-System/actions/workflows/ci.yml/badge.svg)
![License](https://img.shields.io/badge/license-MIT-green)
![Node.js](https://img.shields.io/badge/Node.js-18%2B-brightgreen)
![React](https://img.shields.io/badge/React-18-blue)

> **📌 Sprint Board:** [Jira Project Board](https://YOUR_JIRA_INSTANCE.atlassian.net/jira/software/projects/RMS/boards/YOUR_BOARD_ID) *(replace with your actual URL)*

### 🔗 Quick Links

| Resource | Link |
|----------|------|
| 📋 Sprint Board | [docs/SPRINT_BOARD.md](docs/SPRINT_BOARD.md) |
| 📊 Risk Analysis | [docs/RISK_UPDATES.md](docs/RISK_UPDATES.md) |
| 🎬 Demo Plan | [docs/DEMO_PLAN.md](docs/DEMO_PLAN.md) |
| 🧩 UML Diagram | [docs/UML_UseCase_RestaurantManagementSystem.png](docs/UML_UseCase_RestaurantManagementSystem.png) |
| ⚙️ CI/CD Pipeline | [.github/workflows/ci.yml](.github/workflows/ci.yml) |
...
# 4. Setup Database
# Import the SQL schemas into your MySQL server:
#   - database/cafe_user_auth_role_schema.sql
#   - database/stock_movements_schema.sql
```
